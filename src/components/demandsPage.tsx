        ...
        <div className="hero-text">
            <div className="second hero-text__phrase hero-text__phrase--collapse">
                ...
                <div className="description">
                    ...
                    <p>House the most vulnerable: the homeless, domestic violence survivors, undocumented migrants,
            ...
            <div className="third hero-text__phrase hero-text__phrase--collapse">
                ...
                <div className="description">
                    ...
                    <p>Public housing policies should enforce housing as a right over its mercantilization in the long
                        term.</p>
                </div>
            </div>
        </div>
